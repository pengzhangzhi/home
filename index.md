...
I'm Zhangzhi Peng (彭张智), a BME Ph.D. student at Duke University, trained as a computer scientist. I advocate open sicence and open source and democratize science and knowledge to be accessible to all.  I'm broadly interested in machine learning and protein design. Questions I'm thinking about:
...
- **How to design binders to a target from sequence alone?** 
  - Structure-based protein design has been the star of the show. But what about sequence-based design? Sequences encodes the complete blueprint of a protein and thus in theory, should be on par with their structure-based counterparts. Yet, the chasm are vast. How to fill in the gap?
